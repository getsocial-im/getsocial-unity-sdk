...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class DDGetActivityByIDResponse : TBase
  {
    ...
    public DDGetActivityByIDResponse() {
    }
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("DDGetActivityByIDResponse");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("DDGetActivityByIDResponse(");
      bool __first = true;
      if (Activity != null && __isset.activity) {
