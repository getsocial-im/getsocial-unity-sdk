...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class DDDeleteReactionsRequest : TBase
  {
    ...
    public DDDeleteReactionsRequest() {
    }
              ...
              if (field.Type == TType.Set) {
                {
                  ...
                  TSet _set343 = iprot.ReadSetBegin();
                  for( int _i344 = 0; _i344 < _set343.Count; ++_i344)
                  {
                    SGEntity _elem345;
                    _elem345 = new SGEntity();
                    _elem345.Read(iprot);
                    Ids.Add(_elem345);
                  }
                  iprot.ReadSetEnd();
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("DDDeleteReactionsRequest");
        ...
        if (Ids != null && __isset.ids) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (SGEntity _iter346 in Ids)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("DDDeleteReactionsRequest(");
      bool __first = true;
      if (SessionId != null && __isset.sessionId) {
