...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class DDUpdateMembersResponse : TBase
  {
    ...
    public DDUpdateMembersResponse() {
    }
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("DDUpdateMembersResponse");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("DDUpdateMembersResponse(");
      bool __first = true;
      if (Members != null && __isset.members) {
