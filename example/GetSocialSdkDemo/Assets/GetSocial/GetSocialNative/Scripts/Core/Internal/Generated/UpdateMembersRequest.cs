...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class UpdateMembersRequest : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("UpdateMembersRequest");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("UpdateMembersRequest(");
      bool __first = true;
      if (SessionId != null && __isset.sessionId) {
