...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class DDGetReportedActivitiesRequest : TBase
  {
    ...
    public DDGetReportedActivitiesRequest() {
    }
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("DDGetReportedActivitiesRequest");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("DDGetReportedActivitiesRequest(");
      bool __first = true;
      if (SessionId != null && __isset.sessionId) {
