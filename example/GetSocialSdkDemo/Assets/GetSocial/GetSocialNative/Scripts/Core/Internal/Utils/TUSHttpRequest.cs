...
namespace GetSocialSdk.Core
{
    ...
    public class TUSHttpClient
    {
        ...
        public async Task<TUSHttpResponse> PerformRequestAsync(TUSHttpRequest req)
        {
            ...
            try
            {
                ...
                var responseWeb = await request.GetResponseAsync();
                HttpWebResponse response = (HttpWebResponse)responseWeb;
