...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class GetActivityByIDResponse : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("GetActivityByIDResponse");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("GetActivityByIDResponse(");
      bool __first = true;
      if (Activity != null && __isset.activity) {
