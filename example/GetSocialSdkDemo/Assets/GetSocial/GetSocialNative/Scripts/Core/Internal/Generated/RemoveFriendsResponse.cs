...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class RemoveFriendsResponse : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("RemoveFriendsResponse");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("RemoveFriendsResponse(");
      bool __first = true;
      if (__isset.numberOfFriends) {
