...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class DDDeleteVoteRequest : TBase
  {
              ...
              if (field.Type == TType.Set) {
                {
                  ...
                  TSet _set347 = iprot.ReadSetBegin();
                  for( int _i348 = 0; _i348 < _set347.Count; ++_i348)
                  {
                    string _elem349;
                    _elem349 = iprot.ReadString();
                    OptionIds.Add(_elem349);
                  }
                  iprot.ReadSetEnd();
                }
              } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("DDDeleteVoteRequest");
        ...
        if (OptionIds != null && __isset.optionIds) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter350 in OptionIds)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("DDDeleteVoteRequest(");
      bool __first = true;
      if (SessionId != null && __isset.sessionId) {
