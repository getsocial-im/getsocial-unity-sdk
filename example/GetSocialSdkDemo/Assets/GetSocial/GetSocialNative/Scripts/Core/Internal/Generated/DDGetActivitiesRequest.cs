...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class DDGetActivitiesRequest : TBase
  {
    ...
    /// <summary>
    /// for timeline: target.ID: "timeline", target.Type: Application
    /// </summary>
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("DDGetActivitiesRequest");
        ...
        if (Tags != null && __isset.tags) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter167 in Tags)
            {
        ...
        if (Labels != null && __isset.labels) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter168 in Labels)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("DDGetActivitiesRequest(");
      bool __first = true;
      if (SessionId != null && __isset.sessionId) {
