...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class UpdateMembersResponse : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("UpdateMembersResponse");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("UpdateMembersResponse(");
      bool __first = true;
      if (Members != null && __isset.members) {
