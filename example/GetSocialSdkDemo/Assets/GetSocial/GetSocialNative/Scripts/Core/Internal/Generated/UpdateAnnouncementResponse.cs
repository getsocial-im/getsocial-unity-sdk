...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class UpdateAnnouncementResponse : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("UpdateAnnouncementResponse");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("UpdateAnnouncementResponse(");
      bool __first = true;
      if (Announcement != null && __isset.announcement) {
