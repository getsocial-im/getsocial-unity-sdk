...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class GetGroupMembersResponse : TBase
  {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    SGGroupMember _elem77;
                    _elem77 = new SGGroupMember();
                    _elem77.Read(iprot);
                    Members.Add(_elem77);
                  }
                  iprot.ReadListEnd();
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("GetGroupMembersResponse");
        ...
        if (Members != null && __isset.members) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (SGGroupMember _iter78 in Members)
            {
              _iter78.Write(oprot);
            }
            oprot.WriteListEnd();
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("GetGroupMembersResponse(");
      bool __first = true;
      if (Members != null && __isset.members) {
