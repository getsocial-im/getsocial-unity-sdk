            ...
            if (field.Type == TType.Map) {
              {
                ...
                for( int _i97 = 0; _i97 < _map96.Count; ++_i97)
                {
                  ...
                  _val99 = new AFContent();
                  _val99.Read(iprot);
                  Content[_key98] = _val99;
                }
                iprot.ReadMapEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (Content != null && __isset.content) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (string _iter104 in Content.Keys)
          {
            oprot.WriteString(_iter104);
            Content[_iter104].Write(oprot);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
      ...
      if (Properties != null && __isset.properties) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (string _iter105 in Properties.Keys)
          {
            oprot.WriteString(_iter105);
            oprot.WriteString(Properties[_iter105]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
