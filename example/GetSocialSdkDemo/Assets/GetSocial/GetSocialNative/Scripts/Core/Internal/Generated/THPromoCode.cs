...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class THPromoCode : TBase
  {
    private string _id;
    private string _appId;
    private THUserReference _creator;
    ...
    public THUserReference Creator
    {
      get
      {
        return _creator;
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("THPromoCode");
        ...
        if (CustomData != null && __isset.customData) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter90 in CustomData.Keys)
            {
              oprot.WriteString(_iter90);
              oprot.WriteString(CustomData[_iter90]);
            }
            oprot.WriteMapEnd();
          }
          oprot.WriteFieldEnd();
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("THPromoCode(");
      bool __first = true;
      if (Id != null && __isset.id) {
