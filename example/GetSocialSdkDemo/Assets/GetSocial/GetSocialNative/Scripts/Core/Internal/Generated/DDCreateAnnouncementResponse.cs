...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class DDCreateAnnouncementResponse : TBase
  {
    ...
    public DDCreateAnnouncementResponse() {
    }
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("DDCreateAnnouncementResponse");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("DDCreateAnnouncementResponse(");
      bool __first = true;
      if (Announcement != null && __isset.announcement) {
