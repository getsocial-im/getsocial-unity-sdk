...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class GetChatMessagesRequest : TBase
  {
    private string _sessionId;
    private string _id;
    private string _userId;
    private SGChatPagination _pagination;
    ...
    public SGChatPagination Pagination
    {
      get
      {
        return _pagination;
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("GetChatMessagesRequest");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("GetChatMessagesRequest(");
      bool __first = true;
      if (SessionId != null && __isset.sessionId) {
