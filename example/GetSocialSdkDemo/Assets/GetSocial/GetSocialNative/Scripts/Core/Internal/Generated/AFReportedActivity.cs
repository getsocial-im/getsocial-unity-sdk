...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class AFReportedActivity : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("AFReportedActivity");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("AFReportedActivity(");
      bool __first = true;
      if (Activity != null && __isset.activity) {
