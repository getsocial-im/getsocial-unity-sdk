...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class CreateActivityResponse : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("CreateActivityResponse");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("CreateActivityResponse(");
      bool __first = true;
      if (Activity != null && __isset.activity) {
