...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class CreatePromoCodeRequest : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("CreatePromoCodeRequest");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("CreatePromoCodeRequest(");
      bool __first = true;
      if (SessionId != null && __isset.sessionId) {
