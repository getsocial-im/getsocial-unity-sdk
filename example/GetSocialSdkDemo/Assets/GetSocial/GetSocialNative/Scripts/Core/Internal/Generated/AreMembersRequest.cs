...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class AreMembersRequest : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("AreMembersRequest");
        ...
        if (UserIds != null && __isset.userIds) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter77 in UserIds)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("AreMembersRequest(");
      bool __first = true;
      if (SessionId != null && __isset.sessionId) {
