...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class DDGetGroupsResponse : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("DDGetGroupsResponse");
        ...
        if (Groups != null && __isset.groups) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (SGGroup _iter164 in Groups)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("DDGetGroupsResponse(");
      bool __first = true;
      if (Groups != null && __isset.groups) {
