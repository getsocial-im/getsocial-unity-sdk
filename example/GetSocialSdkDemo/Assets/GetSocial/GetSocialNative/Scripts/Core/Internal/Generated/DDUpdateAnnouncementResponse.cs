...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class DDUpdateAnnouncementResponse : TBase
  {
    ...
    public DDUpdateAnnouncementResponse() {
    }
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("DDUpdateAnnouncementResponse");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("DDUpdateAnnouncementResponse(");
      bool __first = true;
      if (Announcement != null && __isset.announcement) {
