            ...
            if (field.Type == TType.List) {
              {
                ...
                {
                  THAvailableField _elem17;
                  _elem17 = (THAvailableField)iprot.ReadI32();
                  AvailableFields.Add(_elem17);
                }
                iprot.ReadListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (AvailableFields != null && __isset.availableFields) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (THAvailableField _iter22 in AvailableFields)
          {
            oprot.WriteI32((int)_iter22);
          }
          oprot.WriteListEnd();
        }
        oprot.WriteFieldEnd();
      ...
      if (Annotations != null && __isset.annotations) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (string _iter23 in Annotations.Keys)
          {
            oprot.WriteString(_iter23);
            oprot.WriteString(Annotations[_iter23]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
