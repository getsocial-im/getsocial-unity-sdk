...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class CreateGroupRequest : TBase
  {
              ...
              if (field.Type == TType.Map) {
                {
                  ...
                  for( int _i15 = 0; _i15 < _map14.Count; ++_i15)
                  {
                    ...
                    GroupDescription[_key16] = _val17;
                  }
                  iprot.ReadMapEnd();
                }
              } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("CreateGroupRequest");
        ...
        if (Title != null && __isset.title) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter29 in Title.Keys)
            {
              oprot.WriteString(_iter29);
              oprot.WriteString(Title[_iter29]);
            }
            oprot.WriteMapEnd();
          }
          oprot.WriteFieldEnd();
        ...
        if (GroupDescription != null && __isset.groupDescription) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter30 in GroupDescription.Keys)
            {
              oprot.WriteString(_iter30);
              oprot.WriteString(GroupDescription[_iter30]);
            }
            oprot.WriteMapEnd();
          }
          oprot.WriteFieldEnd();
        ...
        if (Permissions != null && __isset.permissions) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (int _iter31 in Permissions.Keys)
            {
              oprot.WriteI32(_iter31);
              oprot.WriteI32(Permissions[_iter31]);
            }
            oprot.WriteMapEnd();
          }
          oprot.WriteFieldEnd();
        ...
        if (Labels != null && __isset.labels) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter33 in Labels)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("CreateGroupRequest(");
      bool __first = true;
      if (SessionId != null && __isset.sessionId) {
