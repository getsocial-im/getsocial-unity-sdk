...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class UnfollowEntitiesRequest : TBase
  {
    ...
    public UnfollowEntitiesRequest() {
    }
              ...
              if (field.Type == TType.Set) {
                {
                  ...
                  TSet _set111 = iprot.ReadSetBegin();
                  for( int _i112 = 0; _i112 < _set111.Count; ++_i112)
                  {
                    string _elem113;
                    _elem113 = iprot.ReadString();
                    EntityIds.Add(_elem113);
                  }
                  iprot.ReadSetEnd();
                }
              } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("UnfollowEntitiesRequest");
        ...
        if (EntityIds != null && __isset.entityIds) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter114 in EntityIds)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("UnfollowEntitiesRequest(");
      bool __first = true;
      if (SessionId != null && __isset.sessionId) {
