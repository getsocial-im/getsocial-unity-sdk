...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class DDCreateActivityResponse : TBase
  {
    ...
    public DDCreateActivityResponse() {
    }
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("DDCreateActivityResponse");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("DDCreateActivityResponse(");
      bool __first = true;
      if (Activity != null && __isset.activity) {
