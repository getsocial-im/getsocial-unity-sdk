...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class RemoveMembersRequest : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("RemoveMembersRequest");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("RemoveMembersRequest(");
      bool __first = true;
      if (SessionId != null && __isset.sessionId) {
