...
namespace GetSocialSdk.Core 
{
  ...
  [Serializable]
  #endif
  public partial class DDRemoveMembersRequest : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("DDRemoveMembersRequest");
        ...
        if (UserIds != null && __isset.userIds) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter146 in UserIds)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("DDRemoveMembersRequest(");
      bool __first = true;
      if (SessionId != null && __isset.sessionId) {
