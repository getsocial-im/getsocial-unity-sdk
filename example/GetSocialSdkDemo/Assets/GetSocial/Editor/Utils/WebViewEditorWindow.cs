...
namespace GetSocialSdk.Editor
{
    ...
    public class WebViewEditorWindow
    {
        ...
        static Type webViewEditorWindowType
        {
            get
            {
                ...
                */
                ...
                return (typeof(UnityEditor.Editor).Assembly).GetType("UnityEditor.Web.WebViewEditorWindowTabs");
        ...
        public static T CreateWebViewEditorWindow<T>(string title, string sourcesPath, int minWidth, int minHeight,
            int maxWidth, int maxHeight) where T : WebViewEditorWindow, new()
        {
            var createMethod = webViewEditorWindowType
                .GetMethod("Create", BindingFlags.Static | BindingFlags.Public | BindingFlags.FlattenHierarchy)
                .MakeGenericMethod(webViewEditorWindowType);
            ...
            EditorApplication.delayCall += () =>
            {
                EditorApplication.delayCall += () =>
                {
                    webView = webViewEditorWindowType
                        .GetField("m_WebView", BindingFlags.NonPublic | BindingFlags.Instance)
                        .GetValue(customWebEditorWindow.webViewEditorWindow);
                    AddGlobalObject<T>();
                };
            };
        ...
        private static void AddGlobalObject<T>() where T : WebViewEditorWindow
        {
        ...
        private static void AddGlobalObject(Type type)
        {
            ...
            {
                jsproxyMgrType.GetMethod("AddGlobalObject")
                    .Invoke(instance, new object[] {type.Name, Activator.CreateInstance(type)});
            }
        }
...
#else
        var invokeJSMethodMethod =
webViewEditorWindowType.GetMethod ("InvokeJSMethod", BindingFlags.NonPublic | BindingFlags.Instance);
