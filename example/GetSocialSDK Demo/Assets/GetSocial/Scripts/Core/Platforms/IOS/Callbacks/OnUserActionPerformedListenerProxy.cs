...
{
    static class OnUserActionPerformedListenerProxy
    {
        public delegate void OnUserActionPerformedDelegate(IntPtr actionPtr, int userPerformedAction, IntPtr finalizeActionPtr);

        [MonoPInvokeCallback(typeof(OnUserActionPerformedDelegate))]
